...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    assert.equal(typeof createMenu(), 'object');
    // const objetoRetornado = createMenu(); // Retorno: { fetchMenu: () => {}, ... }
    assert.equal(typeof createMenu().fetchMenu, 'function');
    ...
    const menu3 = createMenu({ food: 'coxinha', drink: 'cerveja' });
    // objetoRetornado.fetchMenu() // Retorno: objetoQualquer
    assert.deepStrictEqual(menu3.fetchMenu(), { food: 'coxinha', drink: 'cerveja' });
    ...
    const menu = createMenu({ food: { coxinha: 4.5, sopa: 4.0, sashimi: 9.0 }, drink: { agua: 2.5, refrigerante: 5.0 } });
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    // objetoRetornado.order("coxinha");
    // Já foi pedido coxinha no teste 5.
    ...
    assert.equal(menu.pay(), parseFloat((31.5 * 1.1).toFixed(2)));
